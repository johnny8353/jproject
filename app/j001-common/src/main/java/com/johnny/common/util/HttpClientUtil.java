...
/**
 * 类 编 号： 类 名 称：HttpClientUtil 内容摘要：<说明该类的目前已经实现的主要功能> 完成日期：2016年9月9日
...
public class HttpClientUtil {
	...
	/**
	 * * 发送 post请求 * @param httpUrl 地址 * @param params
	...
	/**
	 * * 发送 post请求 * @param httpUrl 地址 * @param maps 参数
	 * @throws Exception 
	 */
	 ...
	 * @throws Exception 
	 */
	public String sendHttpPostJson(String httpUrl, Map<String, String> maps) throws Exception {
		HttpPost httpPost = new HttpPost(httpUrl);
		// 创建httpPost
		// 创建参数队列
		List<NameValuePair> nameValuePairs = new ArrayList<NameValuePair>();

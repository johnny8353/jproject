// ============================ 定义常量 =========================
var TreeImageFolderPath = "../images/icons/treeImages/";
...
var FILE_ClOSE        = TreeImageFolderPath +"file_close.gif";
var FILE_OPEN        = TreeImageFolderPath +"file_open.gif";
...
{
	if(obj.src.indexOf("plus.gif"/*tpa=http://10.30.19.100/svn/demo/js/plus.gif*/)>0)
	{
		changeItemStatus(obj,"expand");
	}
	else if(obj.src.indexOf("minus.gif"/*tpa=http://10.30.19.100/svn/demo/js/minus.gif*/)>0)
	{
...
function TreeTitle_OnClickEvent(obj, childslength)
{
	...
	if(objPrevSelectedTreeItem != "")
	{
		...
		if(objPrevSelectedTreeItem.previousSibling.src.indexOf("file_") != -1)
			objPrevSelectedTreeItem.previousSibling.src = objPrevSelectedTreeItem.previousSibling.src.replace("open.gif"/*tpa=http://10.30.19.100/svn/demo/js/open.gif*/, "close.gif"/*tpa=http://10.30.19.100/svn/demo/js/close.gif*/); //改变文件图标
	...
	obj.previousSibling.src = obj.previousSibling.src.replace("close.gif"/*tpa=http://10.30.19.100/svn/demo/js/close.gif*/, "open.gif"/*tpa=http://10.30.19.100/svn/demo/js/open.gif*/);  //改变文件图标
...
function changeItemStatus(obj,str)
{
	...
	if(str=="expand")
	{
		obj.src = obj.src.replace("plus.gif"/*tpa=http://10.30.19.100/svn/demo/js/plus.gif*/, "minus.gif"/*tpa=http://10.30.19.100/svn/demo/js/minus.gif*/);
		obj.nextSibling.src = obj.nextSibling.src.replace("close.gif"/*tpa=http://10.30.19.100/svn/demo/js/close.gif*/, "open.gif"/*tpa=http://10.30.19.100/svn/demo/js/open.gif*/);
	...
	{
		obj.src = obj.src.replace("minus.gif"/*tpa=http://10.30.19.100/svn/demo/js/minus.gif*/, "plus.gif"/*tpa=http://10.30.19.100/svn/demo/js/plus.gif*/);
		obj.nextSibling.src = obj.nextSibling.src.replace("open.gif"/*tpa=http://10.30.19.100/svn/demo/js/open.gif*/, "close.gif"/*tpa=http://10.30.19.100/svn/demo/js/close.gif*/);
...
function changeAllItemsStatus(str)
{
	...
	{
		if(objItems[i].src.indexOf("minus.gif"/*tpa=http://10.30.19.100/svn/demo/js/minus.gif*/) != -1 || objItems[i].src.indexOf("plus.gif"/*tpa=http://10.30.19.100/svn/demo/js/plus.gif*/) != -1)
		{

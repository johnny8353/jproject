...
<%@ page import="com.johnny.ireport.JRDataSource.PersonDataSource " %>
...
<%
	...
	if (request.getParameter("reload") != null || jasperPrint == null)
	{
		...
		if (!reportFile.exists()) throw new JRRuntimeException("File preson.jasper not found. The report design must be compiled first.");
	...
	int pageIndex = 0;
	int lastPageIndex = 0;
	if (jasperPrint.getPages() != null) lastPageIndex = jasperPrint.getPages().size() - 1;

 ...
 * generated in the com.johnny.webservice.client.jdkimpl package. 
...
public class ObjectFactory {
    ...
    private final static QName _DoHelloResponse_QNAME = new QName("http://jdkimp.webservice.johnny.com/", "doHelloResponse");
    private final static QName _DoHello_QNAME = new QName("http://jdkimp.webservice.johnny.com/", "doHello");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.johnny.webservice.client.jdkimpl
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://jdkimp.webservice.johnny.com/", name = "doHelloResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://jdkimp.webservice.johnny.com/", name = "doHello")

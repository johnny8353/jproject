...
/**
 * 类 编 号：
 * 类 名 称：LoggingOutInterceptorWrap
 * 内容摘要：LoggingOutInterceptor封装类，用于日志持久化
 * 完成日期：2016年9月9日
 * 编码作者：JohnnyHuang 黄福强
 */
public class LoggingOutInterceptorWrap extends LoggingOutInterceptor {
	...
	class LoggingCallback implements CachedOutputStreamCallback {
		...
		public void onClose(CachedOutputStream cos) {
			...
			//johnny 获取输出日志
			String responseLog = formatLoggingMessage(buffer);
